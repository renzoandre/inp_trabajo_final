...
public class ConsultaCallesVuelta extends AsyncTask<Integer, Void, Boolean> {

    public ArrayList<CallesVuelta> lstCallesVuelta = new ArrayList<>();
    ...
    protected Boolean doInBackground(Integer... params) {
        ...
        final String METHOD_NAME = "consultarCallesVueltaPorRutaId";
        ...
        try {
            ...
            for (int i = 0; i < response.getPropertyCount(); i++) {
                ...
                CallesVuelta r = new CallesVuelta();
    ...
    public ArrayList<CallesVuelta> retornarValor() {
        return lstCallesVuelta;
    }
