...
public class ConsultaEmpresasPorCalles extends AsyncTask<String, Void, Boolean> {
    ...
    protected Boolean doInBackground(String... params) {
        ...
        final String METHOD_NAME = "consultarEmpresasPorCalle";
        final String SOAP_ACTION = NAMESPACE + METHOD_NAME;

        SoapObject request = new SoapObject(NAMESPACE, METHOD_NAME);

        request.addProperty("calle", params[0]);
